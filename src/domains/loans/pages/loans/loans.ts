...
export class LoansPage {
    ...
    createLoan() {
        ...
        const dto: CreateLoanDto = {
            ...
            transactionProcessingStrategyCode: product.transactionProcessingStrategyCode ?? APP_DEFAULTS.STRATEGY,
    ...
    updateLoan() {
        ...
        const dto: UpdateLoanDto = {
            ...
            transactionProcessingStrategyCode: loan.transactionProcessingStrategyCode ?? APP_DEFAULTS.STRATEGY,
            disbursementData: [{ expectedDisbursementDate: expectedDate, principal, dateFormat: APP_DEFAULTS.DATE_FORMAT, locale: APP_DEFAULTS.LOCALE }],
            dateFormat: APP_DEFAULTS.DATE_FORMAT,
            locale: APP_DEFAULTS.LOCALE,
        };
